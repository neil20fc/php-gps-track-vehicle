	...
	DateTimePicker.prototype = {
		...
		_modifyPicker: function()
		{
			...
			if(bDisplaySetButton)
				sDTPickerButtons += '<div class="col-xs-6"><a class="btn btn-default dropdown-toggle dtpicker-buttonSet">' + dtPickerObj.settings.setButtonContent + '</a></div>';
			if(bDisplayClearButton)
				sDTPickerButtons += '<div class="col-xs-6"><a class="btn btn-default dropdown-toggle dtpicker-buttonClear">' + dtPickerObj.settings.clearButtonContent + '</a></div>';
		...
		_addEventHandlersForPicker: function()
		{
			...
			$(dtPickerObj.element).find('.close').click(function(e)
			{
